import 'dart:async';
import 'package:anime_world_tutorial/api/get_anime_search.dart';
import 'package:anime_world_tutorial/widget/anime_list_tile.dart';
...
class AnimeSearchDelegate extends SearchDelegate<List<AnimeNode>> {
  Future<Iterable<Anime>> searchAnime(String query) async {
    return await getAnimesbySearchApi(query: query);
  }
  ...
  Widget buildSuggestions(BuildContext context) {
    // Menampilkan saran kosong atau yang lain, tapi tidak memproses API.
    return const Center(
